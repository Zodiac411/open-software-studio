...
2. Gather the lens inputs: current project state and the request for repository evidence, allowed paths, smallest safe change, tests, and handoff
3. Apply the lens method: Apply a bounded review of repository evidence, allowed paths, smallest safe change, tests, and handoff and preserve the evidence trail.
4. Produce the lens output: named IMPLEMENTATION_HANDOFF, EVIDENCE_RECEIPT outputs with evidence and one next action
