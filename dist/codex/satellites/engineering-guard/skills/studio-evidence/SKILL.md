...
description: Grade and validate named evidence against requirement proof levels, freshness, and current repository state.
---
# Studio Evidence

Use this front-door only when the request needs E0 through E5 evidence receipts, direct observations, and unproven boundaries.
...
- This skill does not own unsupported completion claims.
...
- Input: current project state and the request for E0 through E5 evidence receipts, direct observations, and unproven boundaries
- Method: Apply a bounded review of E0 through E5 evidence receipts, direct observations, and unproven boundaries and preserve the evidence trail.
...
2. Gather the lens inputs: current project state and the request for E0 through E5 evidence receipts, direct observations, and unproven boundaries
3. Apply the lens method: Apply a bounded review of E0 through E5 evidence receipts, direct observations, and unproven boundaries and preserve the evidence trail.
