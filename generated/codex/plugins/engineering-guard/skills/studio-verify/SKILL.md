...
2. Gather the lens inputs: current project state and the request for deterministic validators, evidence grading, seeded gates, and honest limitations
3. Apply the lens method: Apply a bounded review of deterministic validators, evidence grading, seeded gates, and honest limitations and preserve the evidence trail.
4. Produce the lens output: named VERIFICATION_CONTRACT, EVIDENCE_RECEIPT outputs with evidence and one next action
