...
Current OpenAI workspace documentation allows administrators to import a GitHub marketplace and configure plugin/app access. Import this repository's root, where `.agents/plugins/marketplace.json` is present, then set installation policy for eligible users.
